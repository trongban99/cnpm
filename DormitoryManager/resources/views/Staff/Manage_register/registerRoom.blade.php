        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class= "res-staff" role="form" method="POST" action="{{URL::to('/saveRegister')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <?php
                       ...
                       <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="select1" name="Student_id" >
                                    <option value="">---Chọn sinh viên----</option>
                                    @foreach($student as $k => $v)
                                    <option value="{{$v->Student_id}}">{{$v->Student_id}}----{{ $v->User_name}}   </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group clearfix">
                                <div class="row">
                                    <label class="col-md-12">Lựa chọn dịch vụ</label> 
                                    <div class="col-md-12">
