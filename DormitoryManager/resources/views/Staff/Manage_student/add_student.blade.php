        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="st" role="form" method="POST" action="{{URL::to('/save-student')}}" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        <?php
                       ...
                       <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                value="{{old('Student_class')}}" name="Student_class" placeholder="Nhập lớp" >
                            </div>
                            <div class="form-group">
                                <label for="">Khoa</label>
                                <input type="text" class="form-control" id="Student_faculty" 
                                value="{{old('Student_faculty')}}" name="Student_faculty" placeholder="Nhập khoa" >
                            </div>
                            <div class="form-group">
                            ...
                            <div class="card-footer">
                                <input type="submit" class="btn btn-primary" name="add_student" value="Thêm Sinh viên"></input>
                            </div>
                    </form>
                </div>
            </div>
